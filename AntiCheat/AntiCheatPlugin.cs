...
namespace AntiCheat
{
    ...
    public class AntiCheatPlugin : BaseUnityPlugin
    {
        ...
        void Awake()
        {
            ...
            ShipConfig5 = Config.Bind("ShipSetting", "Kick", true, "检测强制拉杆行为(检测到该行为时踢出玩家)");
            ...
            ShipBuild2 = Config.Bind("ShipBuildSetting", "Kick", true, "检测到该行为时踢出玩家");

            //GodMode = Config.Bind("GodModeSetting", "Enable", true, "无敌模式检测");
            //GodMode2 = Config.Bind("GodModeSetting", "Kick", true, "检测到该行为时踢出玩家");

            ItemCooldown = Config.Bind("ItemCooldownSetting", "Enable", true, "物品使用冷却异常检测");
            ItemCooldown2 = Config.Bind("ItemCooldownSetting", "Kick", true, "检测到该行为时踢出玩家");
            ...
            ShipTerminal2 = Config.Bind("ShipTerminalSettings", "Kick", true, "检测到该行为时踢出玩家");

            DespawnItem = Config.Bind("DespawnItemSettings", "Enable", true, "销毁物品检测");
            DespawnItem2 = Config.Bind("DespawnItemSettings", "Kick", true, "检测到该行为时踢出玩家");

            ChatReal = Config.Bind("ChatRealSettings", "Enable", true, "发言伪造检测");
            ChatReal2 = Config.Bind("ChatRealSettings", "Kick", true, "检测到该行为时踢出玩家");

            Mask = Config.Bind("MaskSettings", "Enable", true, "刷假人检测");
            Mask2 = Config.Bind("MaskSettings", "Kick", true, "检测到该行为时踢出玩家");

            Gift = Config.Bind("GiftSettings", "Enable", true, "刷礼物盒检测");
            Gift2 = Config.Bind("GiftSettings", "Kick", true, "检测到该行为时踢出玩家");

            Turret = Config.Bind("TurretSettings", "Enable", true, "激怒机枪检测");
            Turret2 = Config.Bind("TurretSettings", "Kick", true, "检测到该行为时踢出玩家");

            Invisibility = Config.Bind("InvisibilitySettings", "Enable", true, "隐身检测");
            Invisibility2 = Config.Bind("InvisibilitySettings", "Kick", true, "检测到该行为时踢出玩家");

              
            Boss = Config.Bind("BossSetting", "Enable", true, "召唤老板检测");
            Boss2 = Config.Bind("BossSetting", "Kick", true, "检测到该行为时踢出玩家");
            
            Jetpack = Config.Bind("JetpackSetting", "Enable", true, "喷气背包爆炸检测");
            Jetpack2 = Config.Bind("JetpackSetting", "Kick", true, "检测到该行为时踢出玩家");


            Landmine = Config.Bind("LandmineSetting", "Enable", true, "引爆地雷检测");
            Landmine2 = Config.Bind("LandmineSetting", "Kick", true, "检测到该行为时踢出玩家");

            SpawnWebTrap = Config.Bind("SpawnWebTrapSetting", "Enable", true, "刷蜘蛛网检测");
            SpawnWebTrap2 = Config.Bind("SpawnWebTrapSetting", "Kick", true, "检测到该行为时踢出玩家");

            Enemy = Config.Bind("EnemySetting", "Enable", true, "怪物异常检测");

            KillEnemy = Config.Bind("KillEnemySetting", "Enable", true, "击杀敌人检测");
            KillEnemy2 = Config.Bind("KillEnemySetting", "Kick", true, "检测到该行为时踢出玩家");
            ...
            GrabObject2 = Config.Bind("GrabObjectSetting", "Kick", true, "检测到该行为时踢出玩家");

            ShovelConfig = Config.Bind("ShovelSettings", "Enable", true, "铲子伤害异常检测");
            ShovelConfig2 = Config.Bind("ShovelSettings", "Kick", true, "检测到该行为时踢出玩家");

            NamelessConfig = Config.Bind("NamelessSettings", "Enable", true, "玩家名字检测(Nameless或Unknown)");
            NamelessConfig2 = Config.Bind("NamelessSettings", "Kick", true, "检测到该行为时踢出玩家");

            FreeBuyConfig = Config.Bind("FreeBuySettings", "Enable", true, "零元购检测");
            FreeBuyConfig2 = Config.Bind("NamelessSettings", "Kick", true, "检测到该行为时踢出玩家");
            //FreeBuyConfig2 = Config.Bind("FreeBuySettings", "PayMap", "titan,rend,dine", "付费地图列表(逗号分割)");

            //ShotgunConfig = Config.Bind("ShotgunSettings", "Enable", true, "禁止玩家枪杀队友");
            //ShotgunConfig = Config.Bind("ShotgunSettings", "Kick", true, "检测到该行为时踢出玩家");

            //SpeedConfig = Config.Bind("SpeedSettings", "Enable", true, "禁止玩家卡加速或使用加速挂");
            //SpeedConfig = Config.Bind("SpeedSettings", "Kick", true, "检测到该行为时踢出玩家");


            //InfiniteAmmoConfig = Config.Bind("InfiniteAmmoSettings", "Enable", true, "禁止玩家无限子弹");
            //InfiniteAmmoConfig2 = Config.Bind("InfiniteAmmoSettings", "Kick", true, "检测到该行为时踢出玩家");

            //InfiniteGiftConfig = Config.Bind("InfiniteGiftSettings", "Enable", true, "禁止玩家使用礼物盒刷物品");
            //InfiniteGiftConfig2 = Config.Bind("InfiniteGiftSettings", "Kick", true, "检测到该行为时踢出玩家");
