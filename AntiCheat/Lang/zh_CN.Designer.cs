...
namespace AntiCheat.Lang {
    ...
    internal class zh_CN {
        ...
        /// <summary>
        ///   查找类似 检测消息显示类型，PublicChat = 显示在房间公共聊天，HostChat = 显示在聊天仅主机可见，GUI = 显示在 GUI 界面中 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 检测到玩家 {player} 负重异常！ 的本地化字符串。
        /// </summary>
