...
&nbsp; 1. 在 AntiCheat 文件目录下找到 locales 文件夹，打开 localization\_cfg.json 文件

&nbsp; 2. 修改 ``current\_language`` 的值

&nbsp;     - 如果为空，反作弊将会根据系统语言自动设置为 zh\_CN/en\_US

&nbsp;     - 如果想指定，请将值设定为 en\_US/zh\_CN
...
&nbsp; 2. 修改文件名，将其修改为你的语言文件名称，例如 en\_US.json -> zh\_CN.json

&nbsp; 3. 更改文件内容，修改完毕后将 ``localization\_cfg.json`` 中 ``current\_language`` 的值
